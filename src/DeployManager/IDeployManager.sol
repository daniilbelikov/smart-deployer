...
interface IDeployManager is IERC165 {
    ...
    /// @param _isActive True if the contract can be deployed
    ...
    /// @notice Emitted when new contract is deployed
    ...
    /// @param _fee (in wei) required for the deployment
    ...
    /// @notice Updated fee for registered contract
    /// @param _contractAddress The address of the registered contract template
    ...
    /// @notice Disable ability to deploy of registered contract 
    /// @param _contractAddress The address of the registered utility template
    /// @dev Sets _isActive to false
    function deactivateContract(address _contractAddress) external;

    /// @notice Activates ability to deploy of registered contract 
    /// @param _contractAddress The address of the registered utility template
